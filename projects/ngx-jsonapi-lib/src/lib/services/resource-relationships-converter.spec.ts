...
describe("ResourceRelationshipsConverter", () => {
    let mock_relationship: DocumentResource<
        MockResource
    > = new DocumentResource<MockResource>();
    ...
    it("should set builded to true when a hasOne relationsihp is builded", () => {
        ...
        expect(
            (resource_relationships_converter as any).relationships_dest
                .resource.builded
        ).toBeTruthy();
    });
    ...
    it(`buildRelationships method should add hasMany and hasOne relationships to relationships_dest as appropiapte
        ...
        let mock_resource_from: DocumentResource<
            MockResource
        > = new DocumentResource<MockResource>();
        ...
        let mock_collection_from: DocumentCollection<
            MockResource
        > = new DocumentCollection<MockResource>();
        ...
        ).toBe("has_one relationship name");
        expect(
            (resource_relationships_converter as any).relationships_dest
                .resource.data.attributes.description
        ...
        expect(
            (resource_relationships_converter as any).relationships_dest
                .collection instanceof DocumentCollection
        ).toBeTruthy();
