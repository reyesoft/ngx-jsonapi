...
describe('core methods', () => {
    ...
    it(`the resource should have the correct hasOne and hasMany relationships correspondig to the back end response's included resources,
        ...
        // let wait = (ms): Promise<void> => new Promise((r, j): number => setTimeout(r, ms));
        // test_response_subject.next((async (): HttpResponse<{}> => {
        //     let response: HttpResponse<{}>;
        //     await wait(2000).then(() => {
        //         response = new HttpResponse({ body: { data: test_resource, included: included }});
        //     });
        //     return response
        // })());
        test_response_subject.next(new HttpResponse({ body: { data: test_resource, included: included }}));
        ...
        await test_service
            ...
            // .subscribe(resource => {
                ...
                // console.log('has_one_relationship --->', has_one_relationship.relationships.test_resource);
