(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('axios'), require('lodash-es')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs', 'rxjs/operators', 'axios', 'lodash-es'], factory) :
	(factory((global['ngx-jsonapi'] = {}),global.rxjs,global.operators,global.axios,global.lodashEs));
}(this, (function (exports,rxjs,operators,axios,lodashEs) { 'use strict';
...
var ClonedDocumentResource = /** @class */ (function () {
    ...
    ClonedDocumentResource.prototype.removeDuplicatedIncludes = function () {
        ...
        this.resource_object.included = this.resource_object.included.filter(function (included_resource) {
            return !lodashEs.isEqual(included_resource, parent_included.find(function (include) { return include.id === included_resource.id; }));
        });
    ...
    ClonedDocumentResource.prototype.removeDuplicatedRelationships = function () {
        ...
        for (var relationship in this.resource_object.data.relationships) {
            if (lodashEs.isEqual(this.resource_object.data.relationships[relationship], this.parent_resource_object.data.relationships[relationship])) {
...
var ClonedResource = /** @class */ (function (_super) {
    ...
    function ClonedResource(resource) {
        ...
        _this.parent = lodashEs.cloneDeep(resource);
...
exports.JSONAPI_RIPPER_SERVICE = JSONAPI_RIPPER_SERVICE;
exports.JSONAPI_STORE_SERVICE = JSONAPI_STORE_SERVICE;
